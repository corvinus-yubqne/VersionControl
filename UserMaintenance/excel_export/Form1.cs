...
namespace excel_export
{
    public partial class Form1 : Form
    {
        ...
        private void CreateTable()
        {
            ...
            ExcelHeaderFormatting(headers);
            ExcelDataFormatting(values);

        }

        private void ExcelDataFormatting(object[,] values)
        {
        ...
        private void ExcelHeaderFormatting(string[] headers)
        {
